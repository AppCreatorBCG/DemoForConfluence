...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int port = Integer.parseInt(settings.getOrDefault("APP_PORT", "10927"));
        // All URLs must be prefixed with the app name, which is got via the APP_NAME env var.
        String appName = settings.getOrDefault("APP_NAME", "DemoForConfluence");
